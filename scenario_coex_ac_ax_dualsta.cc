...
int main(int argc, char *argv[])
{
    ...
    AnimationInterface anim("scratch/netanim/scenario_coex_ac_ax_dualsta.xml");
    ...
    monitor->SerializeToXmlFile("scratch/flowmon/scenario_coex_ac_ax_dualsta.flowmon", true, true);
    Simulator::Destroy();
    return 0;
}
